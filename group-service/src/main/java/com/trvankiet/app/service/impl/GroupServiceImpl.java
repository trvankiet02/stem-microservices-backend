...
public class GroupServiceImpl implements GroupService {
    ...
    public ResponseEntity<GenericResponse> createGroup(String userId, GroupCreateRequest groupCreateRequest) {
        ...
        if (groupCreateRequest.getIsClass()) {
            ...
            if (userDto.getRole().equals("TEACHER")) {
                ...
                group.setYearFrom(groupCreateRequest.getYearFrom());
                group.setYearTo(groupCreateRequest.getYearTo());;
            } else {
    ...
    // Need to update with yearFrom and yearTo
    @Override
    ...
    public ResponseEntity<GenericResponse> getCompetitions() {
        log.info("GroupServiceImpl, getCompetitions");

        List<Group> competitions = groupRepository.findAllByIsCompetition(true);
