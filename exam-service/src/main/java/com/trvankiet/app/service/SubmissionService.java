...
public interface SubmissionService {
    ...
    ResponseEntity<GenericResponse> getRankingByExamId(String userId, String examId);

    ResponseEntity<GenericResponse> getRankByGroupId(String userId, String groupId);
}
